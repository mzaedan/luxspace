                ...
                <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                    <div class="px-4 flex-none">
                        <div class="" style="width: 90px; height: 90px">
                            <img src="{{ $item->product->galleries()->exists() ? asset('storage/' . str_replace('public/', '', $item->product->galleries->first()->url)) : asset('data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==') }}" alt=" chair-1" class="object-cover rounded-xl w-full h-full" />
                        </div>
                    </div>
